...
public class SyGMaster_Wolf extends finderMob implements GeoEntity {
    public String animationprocedure = "empty";
    private long lastSwing;
    private boolean swinging;
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(SyGMaster_Wolf.class, EntityDataSerializers.STRING);
    ...
    public SyGMaster_Wolf(PlayMessages.SpawnEntity packet, Level world) {
        this(SyGIEntity.Master_Wolf.get(), world);
    }

    public SyGMaster_Wolf(EntityType<? extends Monster> pEntityType, Level pLevel) {
