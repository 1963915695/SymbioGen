...
public class SyGMaster_Spider extends finderMob implements GeoEntity {
    public String animationprocedure = "empty";
    private long lastSwing;
    private boolean swinging;
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(SyGMaster_Spider.class, EntityDataSerializers.STRING);
    ...
    public SyGMaster_Spider(PlayMessages.SpawnEntity packet, Level world) {
        this(SyGIEntity.Master_Spider.get(), world);
    }

    public SyGMaster_Spider(EntityType<? extends Monster> pEntityType, Level pLevel) {
