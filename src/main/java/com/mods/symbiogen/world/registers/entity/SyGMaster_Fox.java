...
public class SyGMaster_Fox extends finderMob implements GeoEntity {
    public String animationprocedure = "empty";
    private long lastSwing;
    private boolean swinging;
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(SyGMaster_Fox.class, EntityDataSerializers.STRING);
    ...
    public SyGMaster_Fox(PlayMessages.SpawnEntity packet, Level world) {
        this(SyGIEntity.Master_Fox.get(), world);
    }

    public SyGMaster_Fox(EntityType<? extends Monster> pEntityType, Level pLevel) {
