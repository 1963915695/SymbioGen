...
public class SyGMaster_Pig extends finderMob implements GeoEntity {
    public String animationprocedure = "empty";
    private long lastSwing;
    private boolean swinging;
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(SyGMaster_Pig.class, EntityDataSerializers.STRING);
    ...
    public SyGMaster_Pig(PlayMessages.SpawnEntity packet, Level world) {
        this(SyGIEntity.Master_PIG.get(), world);
    }

    public SyGMaster_Pig(EntityType<? extends Monster> pEntityType, Level pLevel) {
