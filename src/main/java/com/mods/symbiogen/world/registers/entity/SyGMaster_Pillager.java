...
public class SyGMaster_Pillager extends finderMob implements GeoEntity {
    public String animationprocedure = "empty";
    private long lastSwing;
    private boolean swinging;
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(SyGMaster_Pillager.class, EntityDataSerializers.STRING);
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(SyGMaster_Pillager.class, EntityDataSerializers.BOOLEAN);
    ...
    public SyGMaster_Pillager(PlayMessages.SpawnEntity packet, Level world) {
        this(SyGIEntity.Master_Pillager.get(), world);
    }

    public SyGMaster_Pillager(EntityType<? extends Monster> pEntityType, Level pLevel) {
