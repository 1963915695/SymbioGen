...
public class SyGMeleeGoal extends Goal {
    ...
    public SyGMeleeGoal(PathfinderMob pMob, double pSpeedModifier, boolean pFollowingTargetEvenIfNotSeen,boolean IcanPlayer) {
        this.mob = pMob;
    ...
    protected void checkAndPerformAttack(LivingEntity pEnemy, double pDistToEnemySqr) {
        ...
        if (pDistToEnemySqr <= d0 && this.ticksUntilNextAttack <= 0) {
            ...
            if(pEnemy.getEffect(SyGEffect.EXPALE_.get())==null){
               pEnemy.addEffect(new MobEffectInstance(SyGEffect.EXPALE_.get(),10*20,1));
