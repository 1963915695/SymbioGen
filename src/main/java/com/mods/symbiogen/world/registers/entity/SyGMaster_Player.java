...
public class SyGMaster_Player extends finderMob implements GeoEntity {
    public String animationprocedure = "empty";
    private long lastSwing;
    private boolean swinging;
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(SyGMaster_Player.class, EntityDataSerializers.STRING);
    ...
    public SyGMaster_Player(PlayMessages.SpawnEntity packet, Level world) {
        this(SyGIEntity.Master_Player.get(), world);
    }

    public SyGMaster_Player(EntityType<? extends Monster> pEntityType, Level pLevel) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(6,new SyGNearestAttackTargetGoal<>(this, LivingEntity.class, true, LIVING_ENTITY_SELECTOR));
    }
