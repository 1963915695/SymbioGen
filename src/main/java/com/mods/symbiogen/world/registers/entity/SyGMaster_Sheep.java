...
public class SyGMaster_Sheep extends finderMob implements GeoEntity {
    public String animationprocedure = "empty";
    private long lastSwing;
    private boolean swinging;
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(SyGMaster_Sheep.class, EntityDataSerializers.STRING);
    ...
    public SyGMaster_Sheep(PlayMessages.SpawnEntity packet, Level world) {
        this(SyGIEntity.Master_Sheep.get(), world);
    }

    public SyGMaster_Sheep(EntityType<? extends Monster> pEntityType, Level pLevel) {
