...
public class SyGMaster_IPlayer extends finderMob implements GeoEntity {
    public String animationprocedure = "empty";
    private long lastSwing;
    private boolean swinging;
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(SyGMaster_IPlayer.class, EntityDataSerializers.STRING);
    ...
    public SyGMaster_IPlayer(PlayMessages.SpawnEntity packet, Level world) {
        this(SyGIEntity.Master_Iplayer.get(), world);
    }

    public SyGMaster_IPlayer(EntityType<? extends Monster> pEntityType, Level pLevel) {
