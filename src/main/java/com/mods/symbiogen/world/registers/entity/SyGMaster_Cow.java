...
public class SyGMaster_Cow extends finderMob implements GeoEntity {
    public String animationprocedure = "empty";
    private long lastSwing;
    private boolean swinging;
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(SyGMaster_Cow.class, EntityDataSerializers.STRING);
    ...
    public SyGMaster_Cow(PlayMessages.SpawnEntity packet, Level world) {
        this(SyGIEntity.Master_Cow.get(), world);
    }

    public SyGMaster_Cow(EntityType<? extends Monster> pEntityType, Level pLevel) {
