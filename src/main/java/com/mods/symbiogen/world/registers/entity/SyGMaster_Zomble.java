...
public class SyGMaster_Zomble extends finderMob implements GeoEntity {
    public String animationprocedure = "empty";
    private long lastSwing;
    private boolean swinging;
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(SyGMaster_Zomble.class, EntityDataSerializers.STRING);
    ...
    public SyGMaster_Zomble(PlayMessages.SpawnEntity packet, Level world) {
        this(SyGIEntity.Master_Zomble.get(), world);
    }

    public SyGMaster_Zomble(EntityType<? extends Monster> pEntityType, Level pLevel) {
