...
public class SyGMaster_Villager extends finderMob implements GeoEntity {
    public String animationprocedure = "empty";
    private long lastSwing;
    private boolean swinging;
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(SyGMaster_Villager.class, EntityDataSerializers.STRING);
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(SyGMaster_Villager.class, EntityDataSerializers.BOOLEAN);
    ...
    public SyGMaster_Villager(PlayMessages.SpawnEntity packet, Level world) {
        this(SyGIEntity.Master_Villager.get(), world);
    }

    public SyGMaster_Villager(EntityType<? extends Monster> pEntityType, Level pLevel) {
